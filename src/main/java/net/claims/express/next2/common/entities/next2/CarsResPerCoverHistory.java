...
@Entity
@Data
@Table(name = "CARS_RES_PER_COVER_HISTORY")
public class CarsResPerCoverHistory implements Serializable {
...
//    private String resPerCoverCovId;
    ...
    @Id
    @Column(name = "RES_PER_COVER_HIST_ID", nullable = false, length = 36)
    private String resPerCoverHistId;
    ...
    public CarsResPerCoverHistory() {
        resPerCoverHistId = UUID.randomUUID().toString();
    }
